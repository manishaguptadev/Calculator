      ...
      <div className="main w-64 h-auto bg-gray-900 rounded-2xl shadow-xl border-4 border-gray-100">
        <div className="screen p-2">
          <input
            type="text"
            value={result}
            className="text-black w-full shadow=[inset_0_2px_4px_rgba(0,0,0,0.6)] placeholder-black px-1 bg-gray-100 text-2xl pt-10 rounded-lg outline-none text-right"
            placeholder="0"
          />
        </div>
        <div className="brand bg-gray-200 bg-opacity-90 mb-2">
          <h1 className="text-gray-900 text-sm font-bold text-center">
            Devkynus
          </h1>
        </div>
